...
def mainContent():
    if df1 is not None:
        ...
        df_o = df_o.drop(['Height','Gender','Age','Regular cycle', 'No cycle', 'On birth control', 'Carb accuracy', 'Protein target', 'Carbs target', 'Fat target','Calorie accuracy'], axis = 1)
